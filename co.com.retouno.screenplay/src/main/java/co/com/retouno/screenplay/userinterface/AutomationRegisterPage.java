...
public class AutomationRegisterPage extends PageObject {
	...
	public static final Target CHECKBOX_HOBBIE_CRICKET = Target.the("El Checkbox donde se selecciona el Hobbie Cricket").located(By.xpath("//input[@id='checkbox1']"));
	
	public static final Target CHECKBOX_HOBBIE_MOVIES = Target.the("El Checkbox donde se selecciona el Hobbie Movies").located(By.xpath("//input[@id='checkbox2']"));
	
	public static final Target CHECKBOX_HOBBIE_HOCKEY = Target.the("El Checkbox donde se selecciona el Hobbie Hockey").located(By.xpath("//input[@id='checkbox3']"));
	...
	public static final Target BUSCAR_LENGUAJE = Target.the("El campo donde se buscan los lenguajes").located(By.xpath("//ul[@class='ui-autocomplete ui-front ui-menu ui-widget ui-widget-content ui-corner-all']"));
	
	public static final Target LENGUAJE = Target.the("El campo donde se buscan los lenguajes").located(By.xpath("//label[contains(text(),'Languages')]"));	
	...
	public static final Target MENSAJE_ESPERADO = Target.the("El texto de mensaje de bienvenida").located(By.cssSelector("body > section > div:nth-child(1) > div > div:nth-child(2) > h4:nth-child(1)"));
